...
public class TransactionController {
    ...
    @PostMapping("")
    public ResponseEntity<Transaction> depositOrWithdraw(@RequestBody DepositTran depositTran) {
    ...
    public ResponseEntity<Transaction> transferAmount(@RequestBody Transfer transfer) {
